...
# Importing the table registry as `_tables` (not just `Base`) is what actually
...
async def run_async_migrations() -> None:
    ...
    NullPool is used because migrations run once per invocation and
    should not hold pooled connections open between commands.
    """
